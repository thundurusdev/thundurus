...
function fixRemoveCharacterClassElement(context, element) {
    ...
    return context.fixReplaceNode(element, () => {
        ...
        const elementBefore = cc.elements[cc.elements.indexOf(element) - 1];
        const elementAfter = cc.elements[cc.elements.indexOf(element) + 1];
        if (elementBefore &&
            elementAfter &&
